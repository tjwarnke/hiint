...
var AmbientNoiseScene = preload("res://scenes/ambient_noise.tscn")  # Preload AmbientNoise scene
var ambient_noise  # Store reference to AmbientNoise instance
...
func _ready():
	...
	# Initialize and add AmbientNoise to the scene
